...
namespace MyStore
{
    ...
    {
        private static readonly string productsPath = "products.json";
        private static readonly string customersPath = "customers.json";
        private static readonly string ordersPath = "orders.json";
        private static readonly string discountsPath = "discounts.json";
        ...
        public static void SaveDiscounts(List<Discount> discounts)
        {
            try
            {
                var options = new JsonSerializerOptions { WriteIndented = true };
